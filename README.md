...
If publishing to Play Store, you need to fill out the "Declaration Form for MANAGE_EXTERNAL_STORAGE" permission.
...
<true/>
2. App Sandbox
In ios/Runner.xcodeproj, ensure the App Sandbox capability is enabled with appropriate file access entitlements.
...
Windows
No special configuration required. The app has full file system access by default.
